...
- (void)updatePresentationState
{
  ...
  // Adaptation: use Foundation's assertion because Lynx does not depend on React's RCTAssert.
  NSAssert(presentationProvider != nil,
...
- (void)updateConfigurationIfNeeded
{
  ...
  // Adaptation: use Foundation's assertions because Lynx does not depend on React's RCTAssert.
  NSAssert(appearanceProvider != nil, @"[RNScreens] Appearance provider must be set before updating appearance.");
  NSAssert(behaviorProvider != nil, @"[RNScreens] Behavior provider must be set before updating behavior.");
