...
internal class FormSheetDimensionsCoordinator(
    ...
    /**
     * For Lynx shadow layout we require the container height to be "stable" to avoid updating content size in flight.
     * If left as MATCH_PARENT, BottomSheetDialog dynamically applies insets as padding when sheet overflows
     * status bar or display cutout. This causes Lynx to recalculate the layout, resulting in UI flickering
