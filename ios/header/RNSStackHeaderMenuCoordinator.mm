                         ...
                         menuInvalidatedCallback:(nullable void (^)(void))onMenuInvalidated
{
    ...
    if ([element isKindOfClass:[RNSStackHeaderMenuItemData class]]) {
        ...
        NSAssert(!(insideSingleSelection && effectiveItemType == RNSMenuItemTypeAction),
             ...
             identifier:nil
                handler:^(__kindof UIAction *_Nonnull action) {
                    NSArray<NSString *> *toggleItemsIds = insideSingleSelection
                        ? [RNSStackHeaderMenuCoordinator
                              getAllToggleItemsIdsInSingleSelectionHierarchy:singleSelectionRoot]
...
{
    BOOL changed = NO;
    NSMutableArray<id<RNSStackHeaderMenuElement>> *newChildren =
        [NSMutableArray arrayWithCapacity:menu.children.count];
