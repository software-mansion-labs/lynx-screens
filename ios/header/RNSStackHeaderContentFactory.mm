        ...
        UIImage *syncImage = [RNSStackHeaderIconResolver resolveIcon:item.icon
                                                ...
                                                asyncCompletionBlock:^(UIImage *_Nullable image) {
                                                    if (weakBarButtonItem == nil) {
                                                        LLogWarn(
                                                            @"[RNScreens] Attempt to set image on nil UIBarButtonItem");
                                                        return;
                                                    }
                                         ...
                                         frameChangeDelegate:(id<RNSViewFrameChangeDelegate>)delegate
{
    ...
    RNSStackHeaderItemWrapperView *wrapperView = [[RNSStackHeaderItemWrapperView alloc] initWithDelegate:delegate];
    wrapperView.translatesAutoresizingMaskIntoConstraints = NO;
    // contentView has already opted out of default constraints with `translatesAutoresizingMaskIntoConstraints = NO`
    [wrapperView addSubview:contentView];
