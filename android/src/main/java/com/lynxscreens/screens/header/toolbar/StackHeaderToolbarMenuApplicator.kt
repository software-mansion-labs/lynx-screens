...
import com.lynxscreens.screens.header.getResizedDrawable
...
import com.lynxscreens.screens.header.toolbar.model.StackHeaderToolbarMenuGroupMetadata
...
import com.lynxscreens.screens.header.toolbar.update.valueOrNull
...
internal object StackHeaderToolbarMenuApplicator {
    ...
    private fun applyMenuElementOptions(
        ...
        // checked is intentionally not handled here. The selection controller manages it in
