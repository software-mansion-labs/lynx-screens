 ...
 */
// Fresco is the image engine of Lynx's standard image-service setup, so - like RNS,
// which gets it from React Native - we rely on it being initialized by the host app.
