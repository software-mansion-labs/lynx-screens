...
/**
 * Serial, FIFO queue for `updateToolbarMenuElements` UI method batches.
 *
...
internal class StackHeaderToolbarMenuUpdateQueue(
    ...
    internal fun enqueue(batch: List<StackHeaderToolbarMenuElementRawUpdate>) {
        ...
        // Adaptation: plain add() — the K1/stdlib pairing in this project fails to
        // resolve ArrayDeque.addLast; MutableList.add appends identically.
